...
export default {
  ...
  methods: {
    ...
    loadMockData() {
      // Filter orders for current customer (Alice Johnson)
      this.orders = MOCK_ORDERS.filter(o => o.customer.name === 'Alice Johnson');
      this.customerName = 'Alice Johnson';
      this.filterOrders();
    },
    ...
    canAccept(order) {
      ...
      const progressableStatuses = ['Pending', 'Preparing', 'Out for Delivery'];
